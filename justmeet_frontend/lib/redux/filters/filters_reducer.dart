...
final filtersReducers = combineReducers<FiltersState>([
  ...
  TypedReducer<FiltersState, OnCategoriesFilterUpdate>(_onCategoriesFilterUpdate),
]);

FiltersState _onDistanceFilterUpdate(FiltersState state, OnDistanceFilterUpdate action) {
  return state.copyWith(
      distanceFilter: action.newDistanceFilterData
  );
}

FiltersState _onCategoriesFilterUpdate(FiltersState state, OnCategoriesFilterUpdate action) {
